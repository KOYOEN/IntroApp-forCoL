...
public class QuizActivity extends Activity {
    ...
    int a;
    String[] answers = {"if", "ex) 라면⊔찌개", "x"};
    String[] questions = {"⊔choose와 유사한 구조를 가진 문법은?", " ⊔choose가 사용되는 예시하나를 작성해보세요.", "⊔choose는 무한개의 선택지 중 선택을 하는 것입니다. "};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*radio 버튼 숨기기*/
        true_answer.setVisibility(0x00000004);
        false_answer.setVisibility(0x00000004);
        ...
        switch (a) {
            ...
            case 2:
                ...
                answer_sheet.setVisibility(0x00000004);
                true_answer.setVisibility(0x00000002);
                false_answer.setVisibility(0x00000002);
                next.setText("목록으로");
                break;
            case 3:
                finish();
    ...
    Button.OnClickListener SClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            String result2;
            if (a <= 1) {
                String answer = answer_sheet.getText().toString();
                if (answer.equals(answers[a]))
                    result2 = "정답입니다!";
                else
                    result2 = "다시 한번 시도해 보세요!";
            } else {
                if (true_answer.isChecked())
                    result2 = "다시 한번 시도해 보세요!";
                else if (!true_answer.isChecked() && !false_answer.isChecked()) {
                    result2 = "정답을 선택하지 않았습니다.\n정답을 선택해 주세요.";
                } else
                    result2 = "정답입니다!";
            }
            ShowPopUp("정답확인", result2);
        }
    };
